...
Currently working as an AI Research Intern at RecrewAI (GloRoots), I'm passionate about solving complex problems through innovative tech solutions. As a competitive programmer, I've solved 750+ problems across platforms and am continuously honing my skills through hackathons and real-world projects.
...
### RecrewAI [GloRoots] | AI Research Intern
...
- Designed a comprehensive web application for CV-JD matching with advanced prompting techniques

### Amazon ML Summer School | Machine Learning Apprenticeship
**Aug 2024–Sep 2024 | Virtual**
- Engineered LSTM/XGBoost models for stock prediction, achieving 15% RMSE reduction using 30 years of yfinance data
- Built a Flask-based web application to deploy ML models with 63% prediction accuracy for stock forecasting

### Vivada Tech | Software Development Intern
**Feb 2024–Aug 2024 | Pune, Maharashtra**
- Optimized Spring Boot APIs and Selenium-based automation, enhancing reliability by 40% and response efficiency
- Built an LLM-driven fact-checking algorithm using the FakeNewsNet dataset, reducing costs and inference time by 20%
- Developed a collaborative filtering recommendation engine that increased user engagement by 30%
...
- Built a robust file ingestion tool processing 26 file types & 200MB data, enabling multimodal insights via FAISS ANN
- Fine-tuned a 4B parameter LLM model achieving 67% MMLU & 7.84 MT-bench scores for offline document querying
- Deployed RAG pipeline with 20+ enhanced capabilities, improving response accuracy by 30% and processing speed by 25%
...
- Developed a multilingual legal AI assistant, improving information access by 15% for justice services
- Implemented robust support for 40+ languages including regional Indian dialects, substantially expanding accessibility
- Created RAG architecture with judicial datasets, improving query accuracy by 25%

**Tech Stack:** HuggingFace, LangChain, FAISS Vector DB, Streamlit, Google Translator API, Google Cloud, RAG, Ollama
...
- Built a platform supporting 100+ Kashmiri specialties, handling 1000+ daily transactions with real-time inventory
...
- **Solved:** 750+ programming problems
...
- Finalist in Amazon ML Challenge and Flipkart GRiD
- Winner of Adobe Gensolve and FINquest
...
![Computer Vision](https://img.shields.io/badge/Computer_Vision-%23FA7343.svg?style=flat&logo=opencv&logoColor=white)
